...
namespace appDimak.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            if (orderDetail == null)
            {
                return NotFound(); //este es el que retorna error 404 cuando solo paso 1 argumento de la clave primaria compuesta
            }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            if (id == null || _context.OrderDetails == null)
            {
                return NotFound(); //Eso me devolveria el error 404 ya que no hay gestion de errores en el codigo.
            }
